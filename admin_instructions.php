...
function post_notification_admin_sub() {
    ...
    <ol>
        <li>
            ...
            <p><?php echo __( 'I\'m very bad in writing documentation. Please check the PN Forum for support! And look around whether someone else already asked that question.', 'post_notification' ); ?>
                <br/>
        ...
        <li>
            ...
            <p><?php echo __( 'With each new post an email is sent to every registered user in the database. The email can be text or HTML.', 'post_notification' ); ?>
                <br/>
        ...
        <li>
            ...
            <p>
                <em> <?php _e( 'If you want to modify the templates please copy your favorite template in to the folder &lt;wp-dir&gt;/wp-content/post_notification. Afterwards rename it to whatever you like.', 'post_notification' ); ?></em>
            ...
            <ul>
                ...
                <li>@@conf_url
                    - <?php _e( 'The URL that has to be visited to verify the subscription.', 'post_notification' ); ?></li>
            </ul>
            </p>
            <p>
            ...
            <ul>
                ...
                <li>reg_success.tmpl
                    - <?php _e( 'This is the page you see after subscribing.', 'post_notification' ); ?></li>
                <li>confirm.tmpl
                    - <?php _e( 'This email is sent with the activation-link in it.', 'post_notification' ); ?></li>
                <li>select.tmpl
                    - <?php _e( 'The page you see to select your categories.', 'post_notification' ); ?></li>
                <li>unsubscribe.tmpl
                    - <?php _e( 'This email is sent in case someone unsubscribes.', 'post_notification' ); ?></li>
                <li>strings.php
                    - <?php _e( 'In this file all the other strings needed are saved.', 'post_notification' ); ?></li>
            </ul>
            </p>
        </li>
        ...
        <li>
            ...
            <p><?php _e( 'Please report bugs. Finding bugs is much more difficult then fixing them.', 'post_notification' ); ?>
                <br/>
                <b><a
        ...
        <li><strong><?php _e( 'Donations', 'post_notification' ); ?></strong>
            ...
            <ul>
                ...
                <li><?php _e( 'Donate money:', 'post_notification' ); ?> <a
                            href="https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=morty%40gmx%2ede&item_name=Post%20Notification&no_shipping=1&no_note=1&tax=0&currency_code=EUR&bn=PP%2dDonationsBF&charset=UTF%2d8">Paypal </a>
                </li>
            </ul>
        </li>
        <li><strong><?php _e( 'Supporters', 'post_notification' ); ?></strong>
            <ul>
                ...
                <li><a href="http://caspi.org.il/">Eitan
                        Caspi</a>: <?php _e( 'Hebrew translation', 'post_notification' ); ?></li>
                <li>
                    <a href="http://www.werkgroepen.net/wordpress/vertaald-plugin-post-notification/">Anja</a>: <?php _e( 'Dutch translation', 'post_notification' ); ?>
                </li>
                <li><a href="http://www.christian.sasse.com/">Christian
                        Sasse</a>: <?php _e( 'Testing and bugs', 'post_notification' ); ?></li>
