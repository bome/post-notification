...
function post_notification_admin_sub() {
	...
	if ( ! empty( $_POST['updateSettings'] ) ) {
		...
		update_option( 'post_notification_use_wc_mailer', $_POST['use_wc_mailer'] );
            ...
            <tr class="pn_row">
                ...
                <td class="pn_td">
                    <input name="nervous" type="text" id="nervous" size="35"
                           value="<?php echo get_option( 'post_notification_nervous' ); ?>"/> <?php _e( 'seconds.', 'post_notification' ); ?>
                </td>
            </tr>
            <tr class="pn_row">
                <td></td>
        ...
        <table class="post_notification_admin_table">
            ...
            <tr class="pn_row">
                ...
                <td class="pn_td"><input name="read_more" type="text" size="35"
                                         value="<?php echo get_option( 'post_notification_read_more' ); ?>"/></td>
            </tr>
            <tr class="pn_row">
                <td></td>
            ...
            <tr class="pn_row">
                ...
                <td class="pn_td"><input name="subject" type="text" size="35"
                                         value="<?php echo get_option( 'post_notification_subject' ); ?>"/></td>
            </tr>
            <tr class="pn_row">
                <td></td>
            ...
            <tr class="pn_row">
                ...
                <td class="pn_td"><input name="from_name" type="text" size="35"
                                         value="<?php echo get_option( 'post_notification_from_name' ); ?>"/></td>
            </tr>
            <tr class="pn_row">
                <td></td>
                <td class="pn_td"><?php _e( 'Use @@blogname as placeholder for the blog name.', 'post_notification' ); ?>
            ...
            <tr class="pn_row">
                ...
                <td class="pn_td"><input name="from_email" type="text" size="35"
                                         value="<?php echo get_option( 'post_notification_from_email' ); ?>"/></td>
            </tr>
        ...
        <table class="post_notification_admin_table">
            ...
            <tr class="pn_row">
                ...
                <td class="pn_td"><input name="maxmails" type="text" id="maxmail" size="35"
                                         value="<?php echo get_option( 'post_notification_maxsend' ); ?>"/></td>
            </tr>
            ...
            <tr class="pn_row">
                ...
                <td class="pn_td"><input name="pause" type="text" id="pause" size="35"
                                         value="<?php echo get_option( 'post_notification_pause' ); ?>"/> <?php _e( 'seconds.', 'post_notification' ); ?>
                </td>
            </tr>
            ...
            <tr class="pn_row">
                ...
                <td class="pn_td"><input name="unsubscribe_email" type="text" id="pn_url" size="60"
                                         value="<?php echo get_option( 'post_notification_unsubscribe_email' ); ?>"/>
                </td>
            </tr>
        </table>
        ...
        <table class="post_notification_admin_table">
            ...
            <tr class="pn_row">
                ...
                <td class="pn_td"><input name="page_name" type="text" id="page_name" size="60"
                                         value="<?php echo get_option( 'post_notification_page_name' ); ?>"/></td>
            </tr>
            ...
            <tr class="pn_row">
                ...
                <td class="pn_td"><input name="captcha" type="text" size="60"
                                         value="<?php echo get_option( 'post_notification_captcha' ); ?>"/></td>
            </tr>
            <tr class="pn_row">
                <td></td>
                <td class="pn_td">
            ...
            <tr class="pn_row">
                ...
                <td class="pn_td"><input name="pn_url" type="text" id="pn_url" size="60"
                                         value="<?php echo get_option( 'post_notification_url' ); ?>"/></td>
            </tr>
            <tr class="pn_row">
                <td></td>
                <td class="pn_td">
